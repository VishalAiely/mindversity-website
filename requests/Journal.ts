...
export const getEntries = () =>
  fetch("https://mindversity-website-test-2z20mnzro.vercel.app/api/journal/getByReviewStatus?reviewed=true", {
    method: "GET",
    mode: "same-origin",
    headers: {
...
export const getEntriesByType = async (type: any) => {
  ...
  return fetch(`https://mindversity-website-test-2z20mnzro.vercel.app/api/journal/getByType?type=${type}`, {
    method: "GET",
    mode: "same-origin",
    headers: {
      "Content-Type": "application/json",
...
export const getPostById = async (id: any) => (
  fetch(`https://mindversity-website-test-2z20mnzro.vercel.app/api/journal/getById?id=${id}`, {
    method: "GET",
    mode: "same-origin",
    headers: {
      "Content-Type": "application/json",
